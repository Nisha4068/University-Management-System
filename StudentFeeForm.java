...
public class StudentFeeForm extends JFrame implements ActionListener {
    ...
    StudentFeeForm() {
        ...
        lblrollnumber.setBounds(40, 60, 190, 20);
        ...
        // Update labels whenever roll number changes
        crollno.addActionListener(e -> {
            try {
                Conn c = new Conn();
                String selectedRoll = (String) crollno.getSelectedItem();
        ...
        // Initialize with the first roll number if exists
        if (crollno.getItemCount() > 0) {
            crollno.setSelectedIndex(0);
        }
       ...
       lblcourse.setFont(new Font("Tahoma",Font.BOLD,16));
        ...
        String course[] = {"B.Tech","Bsc","M.Tech","Bca","MCA","Msc","B.Com","M.Com"};
        ...
        update.setFont(new Font("Tahona",Font.BOLD,15));
